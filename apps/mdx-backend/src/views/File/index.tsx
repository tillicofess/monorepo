...
const File: React.FC = () => {
	...
	const [currentPath, setCurrentPath] = useState<BreadcrumbItem[]>([
		{
			id: null,
			name: <FormattedMessage id="file.root" defaultMessage="Root Directory" />,
		},
	]);
				...
				>
					<Space direction="vertical" size="middle" style={{ width: "100%" }}>
						...
						<FileTable
							...
							onRename={(id, name) =>
								useFileStore.getState().rename.open(id, name)
							}
							onDelete={(id, name, isDir) =>
								useFileStore.getState().delete.open(id, name, isDir)
							}
						/>
					</Space>
