...
**核心视觉风格**: 极简主义与克制用色，打造"专业、冷静、高效"的数字体验。
...
**色彩系统**:
- 背景: 纯白或极浅灰 (zinc-50, slate-50)
- 卡片: 纯白，通过细边框 (1px) 与背景区分
- 标题: 深黑色 (zinc-950, 接近 #000)
- 正文: 中灰色 (zinc-600)
- 元数据: 浅灰色 (zinc-400)
- 强调色: 极少使用，保留图标原始品牌色作为点缀

**边框与分割线**:
- 使用极细浅灰边框划分区域 (1px solid)
- 避免阴影或色块，保持轻盈锐利感

**排版**:
- 字体: 现代无衬线 (Inter, San Francisco, Segoe UI)
- 标题: Bold，字间距紧凑
- 正文: Regular，行高 1.5-1.6
- 代码: 等宽字体 (Monospace)

**组件设计**:
- 圆角: 6px-12px (rounded-lg, rounded-xl)
- 卡片式布局，包含缩略图、标题、描述、日期
- 侧边栏: 图标+文字左对齐，选中态用左侧指示条
